...
public class StatefulDumbJob implements Job {
  ...
  public void execute(JobExecutionContext context) throws JobExecutionException {
    System.err.println(Thread.currentThread().getName() + "---" + context.getJobDetail().getKey() + " executing.[" + new Date() + "]");
    ...
    System.err.println(Thread.currentThread().getName() + "  -" + context.getJobDetail().getKey() + " complete (" + executeCount + ").");
